...
namespace ChienTsang
{
    public partial class Purchase : Form
    {
        ...
        private void Form6_Load(object sender, EventArgs e)
        {
            ...
            //DGV1、2中文欄位
            dataGridView1.Columns[0].HeaderText = "單據編號";     //改中文欄位名稱
            dataGridView1.Columns[1].HeaderText = "單據日期";
            dataGridView1.Columns[2].HeaderText = "公司編號";
            dataGridView1.Columns[3].HeaderText = "性質";

            dataGridView2.Columns[0].HeaderText = "單據編號";     //改中文欄位名稱
            dataGridView2.Columns[1].HeaderText = "序號";
            dataGridView2.Columns[2].HeaderText = "成品編號";
            dataGridView2.Columns[3].HeaderText = "進銷數量";
            dataGridView2.Columns[4].HeaderText = "成品單價";
            dataGridView2.Columns[5].HeaderText = "批號";
            dataGridView2.Columns[6].HeaderText = "訂單編號";
            dataGridView2.Columns[7].HeaderText = "備註";
        }
    }
}
